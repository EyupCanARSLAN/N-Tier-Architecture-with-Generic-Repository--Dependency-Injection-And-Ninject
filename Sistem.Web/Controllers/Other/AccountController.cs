...
namespace IdentitySample.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ////Default User Role ; Costemer olarak atanıyor...
                    //await UserManager.AddToRoleAsync(User.Identity.GetUserId().ToString(), "Customer");
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            //Default User Role ; Costemer olarak atanıyor...
            if (result.Succeeded) await UserManager.AddToRoleAsync(userId, "Customer");
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            if (!ModelState.IsValid) return View(model);
            var user = await UserManager.FindByNameAsync(model.Email);
            if (user == null) return RedirectToAction("ResetPasswordConfirmation", "Account"); // Don't reveal that the user does not exist
